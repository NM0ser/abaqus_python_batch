...
#           *InstanceName2
#           21,22,23,24,25,26
odbSetStr_global = 'ROD12BACKS_NSET' 
#
...
csvFieldValFileHeader_global = ['Node Label', 'X1', 'X2', 'X3', 'V1', 'V2', 'V3']
#
